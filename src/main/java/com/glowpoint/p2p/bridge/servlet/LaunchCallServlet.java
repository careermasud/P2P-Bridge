 ...
 * @author Masud
 */
//@WebServlet(name = "LaunchCallServlet", urlPatterns = {"/LaunchCallServlet"})
public class LaunchCallServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stat.setDialNumber(request.getParameter("dial_number"));
            
            LaunchCallResponse res = stub.launchCall(stat);
